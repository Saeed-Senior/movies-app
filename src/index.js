...
const initialState = {
  ...
  cardDate: {
    ...
    runtime: '0',
    genres: ['Nothing'],
    banner: 'https://collider.com/wp-content/uploads/gangster-squad-poster-banner.jpg',
...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case 'comment':
      return {...state, cardDate: {...state.cardDate, comments: [...state.cardDate.comments, action.payload]}};
    default:
      return state;
  }
}
